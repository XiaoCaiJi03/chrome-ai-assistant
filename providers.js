const AI_PROVIDERS = {
  openai: {
    ...
    modelsPath: '/models',
    protocol: 'openai',
    defaultModels: ['gpt-5', 'gpt-5-mini', 'gpt-4.1-mini', 'gpt-4.1', 'gpt-4o-mini', 'o4-mini', 'o3'],
    defaultModel: 'gpt-5-mini',
    filter: (id) => /^(gpt-|o1|o3|o4|o5|chatgpt)/i.test(id) && !/(embed|tts|whisper|dall|image|moderation|audio|realtime|search|transcribe|preview|codex|nano)$/i.test(id),
  },
  anthropic: {
  ...
  gemini: {
    ...
    filter: (id) => /gemini/i.test(id) && !/(embed|aqa|tts|image|vision-only|nano)/i.test(id),
  },
  deepseek: {
    label: 'DeepSeek',
  ...
  zhipu: {
    ...
    modelsPath: '/models',
    protocol: 'openai',
    defaultModels: ['glm-5', 'glm-5-air', 'glm-4.7', 'glm-4.6', 'glm-4.6-flash'],
  ...
  qwen: {
    ...
    modelsPath: '/models',
    protocol: 'openai',
    defaultModels: ['qwen3-max', 'qwen3-plus', 'qwen3-flash', 'qwen3-coder-plus', 'qwen-max', 'qwen-plus'],
    defaultModel: 'qwen3-flash',
  },
  openrouter: {
    label: 'OpenRouter',
    ...
    modelsPath: '/models',
    protocol: 'openai',
    defaultModels: ['openai/gpt-5-mini', 'anthropic/claude-sonnet-4.5', 'google/gemini-2.5-flash', 'xai/grok-4', 'deepseek/deepseek-v4-flash'],
  ...
  groq: {
    ...
    modelsPath: '/models',
    protocol: 'openai',
    defaultModels: ['llama-3.3-70b-versatile', 'llama-3.1-8b-instant', 'gpt-oss-120b', 'gpt-oss-20b'],
  ...
  xai: {
    ...
    modelsPath: '/models',
    protocol: 'openai',
    defaultModels: ['grok-4', 'grok-4-fast-reasoning', 'grok-4-fast-non-reasoning', 'grok-3-mini'],
  ...
  together: {
    ...
    modelsPath: '/models',
    protocol: 'openai',
    defaultModels: ['meta-llama/Llama-4-Maverick-17B-128E-Instruct-FP8', 'meta-llama/Llama-3.3-70B-Instruct-Turbo', 'deepseek-ai/DeepSeek-V3.2'],
  ...
  siliconflow: {
    ...
    modelsPath: '/models',
    protocol: 'openai',
    defaultModels: ['Qwen/Qwen3-235B-A22B-Instruct-2507', 'deepseek-ai/DeepSeek-V3.2', 'meta-llama/Llama-4-Maverick-17B-128E-Instruct-FP8'],
  ...
  ollama: {
    ...
    modelsPath: '/models',
    protocol: 'openai',
    defaultModels: ['llama3.3', 'qwen3', 'gemma3', 'deepseek-v3'],
